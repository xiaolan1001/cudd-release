...
# /home/winter/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -ordering dfs -autodyn -automethod sifting -reordering sifting -drop ./nanotrav/C880.blif
# CUDD Version 3.0.0
...
Number of cache collisions: 2598
Number of cache deletions: 28013
Cache used slots = 18.01% (expected 0.00%)
...
Maximum resident size            =  7628K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1999
Swaps = 0
Input blocks = 0
Output blocks = 8
