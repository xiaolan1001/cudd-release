...
# /home/winter/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -second ./nanotrav/miniSecond.blif ./nanotrav/miniFirst.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7564K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1271
Swaps = 0
Input blocks = 0
Output blocks = 8
