...
# /home/winter/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -ordering dfs -reordering win4 -verify ./nanotrav/s27.blif ./nanotrav/s27b.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7496K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1281
Swaps = 0
Input blocks = 0
Output blocks = 8
