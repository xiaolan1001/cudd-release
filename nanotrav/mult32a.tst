...
# /home/winter/research/cudd-release/nanotrav/.libs/nanotrav -p 1 -autodyn -reordering sifting -trav ./nanotrav/mult32a.blif
# CUDD Version 3.0.0
...
Number of cache collisions: 1353
Number of cache deletions: 21069
Cache used slots = 17.74% (expected 10.53%)
Soft limit for cache size: 100352
Number of buckets in unique table: 25088
Used buckets in unique table: 12.38% (expected 12.44%)
...
Maximum resident size            =  7544K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1911
Swaps = 0
Input blocks = 0
Output blocks = 16
